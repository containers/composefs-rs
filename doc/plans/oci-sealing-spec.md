...
"composefs digest" here means the fsverity digest of the EROFS metadata file. However, fsverity is configurable based on digest (SHA-256 or SHA-512 currently) as well as block size (4k and e.g. 64k).

For standardized short form of the combination, a string of the form `${DIGEST}-${BLOCKSIZEBITS}` is used:

- `sha256-12` (SHA-256, 4k block size, 2^12)
- `sha512-12` (SHA-512, 4k block size)
- `sha256-16` (SHA-256, 64k block size, 2^16)

Digests are encoded as lowercase hexadecimal.

### Recommended default algorithm

The suggested default is `sha512-12` - this maximizes compatibility as
  ...
  "layers": [
    {
      ...
      "size": 32654,
      "annotations": {
        "composefs.layer.sha512-12": "3abb6677af34ac57c0ca5828fd94f9d886c26ce59a8ce60ecf6778079423dccff1d6f19cb655805d56098e6d38a1a710dee59523eed7511e5a9e4b8ccb3a4686"
      }
    },
    {
      "mediaType": "application/vnd.oci.image.layer.v1.tar+gzip",
      ...
      "size": 16724,
      "annotations": {
        "composefs.layer.sha512-12": "63e22ec2fbeebabf005e58fbfb0eee607c4aa417045a68a0cc63767b048e3559268d35e72f367d3b2dbd5dbddf12fc4397762ba149260b3795a0391713bddcd7"
      }
    },
    {
      "mediaType": "application/vnd.oci.image.layer.v1.tar+gzip",
      ...
      "size": 73109,
      "annotations": {
        "composefs.layer.sha512-12": "2b59d179d9815994f687383a886ea34109889756efca5ab27318cc67ce2a21261d12fa6fee6b8c716f72214ead55ee0d789d6c35cff977d40ef5728ba9188a80"
      }
    }
  ]
}
...
Additionally, a "rolling" digest may be provided that is the *flattened* merged filesystem
tree of the stack of layers up to that point. The rationale is that it makes it easier for
a runtime to avoid the overhead of individual mounts if it chooses to do so.

Note that it is not required to include this additional digest for *each* layer. A build
system could choose to only emit this `merged` annotation on a final layer. This is especially
suitable for e.g. a "base image" whose stack of mounts would commonly be shared with higher
level applications.
  ...
  "layers": [
    {
      ...
      "annotations": {
        "composefs.layer.sha512-12": "3abb6677af34ac57c0ca5828fd94f9d886c26ce59a8ce60ecf6778079423dccff1d6f19cb655805d56098e6d38a1a710dee59523eed7511e5a9e4b8ccb3a4686",
        "composefs.merged.sha512-12": "3abb6677af34ac57c0ca5828fd94f9d886c26ce59a8ce60ecf6778079423dccff1d6f19cb655805d56098e6d38a1a710dee59523eed7511e5a9e4b8ccb3a4686"
      }
    },
    {
      "mediaType": "application/vnd.oci.image.layer.v1.tar+gzip",
      ...
      "annotations": {
        "composefs.layer.sha512-12": "63e22ec2fbeebabf005e58fbfb0eee607c4aa417045a68a0cc63767b048e3559268d35e72f367d3b2dbd5dbddf12fc4397762ba149260b3795a0391713bddcd7",
        "composefs.merged.sha512-12": "d015f70f8bee6cf6453dd5b771eec18994b861c646cec18e2a9dfdec93f631fbb9030e60cfc82b552d33b9a134312a876ef4e519bffe3ef872aefbd84e6198b3"
      }
    }
  ]
}
...
Note: For the first layer, `composefs.merged.sha512-12` equals `composefs.layer.sha512-12` since a single layer's merge is itself.
...
Signatures MAY also be embedded as manifest annotations using a `.signature` suffix on digest annotations (e.g. `composefs.layer.sha512-12.signature` with base64-encoded PKCS#7), though this requires modifying the image manifest.
...
4. M `type: "merged"` entries — one per layer that has a merged digest, in manifest order. Only layers with a merged digest get a merged signature entry.
...
Each layer blob is a raw PKCS#7 DER signature over the kernel's `fsverity_formatted_digest`:
...
Composefs algorithm identifiers map to kernel constants as algorithm-blocksize with no salt:
- `sha512-12` → `FS_VERITY_HASH_ALG_SHA512`, 4096-byte blocks
- `sha256-12` → `FS_VERITY_HASH_ALG_SHA256`, 4096-byte blocks

All entries in a single signature artifact MUST use the same algorithm. The algorithm is declared in the `composefs.algorithm` annotation on the signature artifact manifest (e.g. `sha512-12`).
...
Discovery uses the standard OCI referrers API:
```
...
```json
{
  ...
  "annotations": {
    "composefs.layer.sha512-12": "3abb6677af34ac57c0ca5828fd94f9d886c26ce59a8ce60ecf6778079423dccff1d6f19cb655805d56098e6d38a1a710dee59523eed7511e5a9e4b8ccb3a4686",
    "composefs.layer.sha512-12.signature": "MIIBkgYJKo...base64-encoded-pkcs7...",
